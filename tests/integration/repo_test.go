...
func TestViewRepoWithSymlinks(t *testing.T) {
	...
	assert.Equal(t, "a: tw-me-2 svg octicon-file-directory-fill", items[0])
	assert.Equal(t, "link_b: tw-me-2 svg octicon-file-directory-symlink", items[1])
	assert.Equal(t, "link_d: tw-me-2 svg octicon-file-symlink-file", items[2])
	assert.Equal(t, "link_hi: tw-me-2 svg octicon-file-symlink-file", items[3])
	assert.Equal(t, "link_link: tw-me-2 svg octicon-file-symlink-file", items[4])
}
