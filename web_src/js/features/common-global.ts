import $ from 'jquery';
import '../vendor/jquery.are-you-sure';
import {clippie} from 'clippie';
import {createDropzone} from './dropzone';
import {showGlobalErrorMessage} from '../bootstrap';
import {handleGlobalEnterQuickSubmit} from './comp/QuickSubmit';
import {svg} from '../svg';
import {hideElem, showElem, toggleElem, initSubmitEventPolyfill, submitEventSubmitter} from '../utils/dom';
import {htmlEscape} from 'escape-goat';
import {showTemporaryTooltip} from '../modules/tippy';
import {confirmModal} from './comp/ConfirmModal';
import {showErrorToast} from '../modules/toast';
import {request, POST, GET} from '../modules/fetch';
import '../htmx';
