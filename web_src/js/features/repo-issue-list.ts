import $ from 'jquery';
import {updateIssuesMeta} from './repo-issue';
import {toggleElem, hideElem, isElemHidden} from '../utils/dom';
import {htmlEscape} from 'escape-goat';
import {confirmModal} from './comp/ConfirmModal';
import {showErrorToast} from '../modules/toast';
import {createSortable} from '../modules/sortable';
import {DELETE, POST} from '../modules/fetch';
