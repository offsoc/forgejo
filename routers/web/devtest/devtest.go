...
func Tmpl(ctx *context.Context) {
	...
	ctx.Data["TrustedVerif"] = &asymkey.ObjectVerification{Verified: true, SigningUser: userNonZero, TrustStatus: "trusted"}
	ctx.Data["UntrustedVerif"] = &asymkey.ObjectVerification{Verified: true, SigningUser: userNonZero, TrustStatus: "untrusted"}
	ctx.Data["UnmatchedVerif"] = &asymkey.ObjectVerification{Verified: true, SigningUser: userNonZero, TrustStatus: ""}
	ctx.Data["WarnVerif"] = &asymkey.ObjectVerification{Verified: false, Warning: true, SigningUser: userNonZero}
	ctx.Data["UnknownVerif"] = &asymkey.ObjectVerification{Verified: false, Warning: false, SigningUser: userNonZero}
	userUnknown := &user.User{ID: 0}
	ctx.Data["TrustedVerifUnk"] = &asymkey.ObjectVerification{Verified: true, SigningUser: userUnknown, TrustStatus: "trusted"}
	ctx.Data["UntrustedVerifUnk"] = &asymkey.ObjectVerification{Verified: true, SigningUser: userUnknown, TrustStatus: "untrusted"}
	ctx.Data["UnmatchedVerifUnk"] = &asymkey.ObjectVerification{Verified: true, SigningUser: userUnknown, TrustStatus: ""}
	ctx.Data["WarnVerifUnk"] = &asymkey.ObjectVerification{Verified: false, Warning: true, SigningUser: userUnknown}
	ctx.Data["UnknownVerifUnk"] = &asymkey.ObjectVerification{Verified: false, Warning: false, SigningUser: userUnknown}
